...
//   //import { Drive,Contents } from '@jupyterlab/services';
...
//           const branches: Airtorch.IVariable[] = [];
//           let variableObject;
//           let variableJson;
...
//             branches.push(variableJson);
//           });
  
//           /*let torch_esp1 = new TorchVariables(result_esp1[0],result_esp1[0],result_esp1[0]);
//           let torch_esp2 = new TorchVariables(result_esp1[1],result_esp1[1],result_esp1[1]);
//           console.log("torch_esp6   "+result_esp1);
  
//           console.log("torch_esp1   "+torch_esp1.name);
//           console.log("torch_esp2   "+torch_esp1.variable_name);
//           console.log("torch_esp3   "+torch_esp1.line_code);
//           console.log("torch_esp4   "+torch_esp1.is_torched_variable);
//           console.log("torch_esp5   "+torch_esp1.tag);
  
//           let b1 = torch_esp1.createJsonObject();
//           let b2 = torch_esp2.createJsonObject();
//           const branches = [b1,b2];*/
  
  
//           /*const branches = [
//             {
//             is_torched_variable: true,
//             name: 'Apple',
//             variable_name: 'Apple',
//             line_code: 'Apple is first variable',
//             tag: 'string'
//           },
//           {
//             is_torched_variable: true,
...
//             line_code: 'Banana is second variable',
//             tag: 'string'
//           },
//           {
//             is_torched_variable: true,
